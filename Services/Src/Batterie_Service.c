...
#define BATTERIE_GPIO_PIN	GPIOA
#define BATTERIE_GPIO_PIN	0

#define BATTERIE_SPEED_TIMER 					TIM2
#define BATTERIE_SPEED_TIMER_CHANNEL	2
#define BATTERIE_SPEED_TIMER_ARR			60
#define BATTERIE_SPEED_TIMER_PSC			60
#endif
